...
import 'widgets/save_image_sqlite.dart';
...
class MyPhotoPage extends StatefulWidget {
  @override
  State createState() {
    return MyPhotoPageState();
  }
}

class MyPhotoPageState extends State<MyPhotoPage> {
...
return Scaffold(
  ...
  body: SafeArea(
    child: WebBrowser(
      initialUrl:'https://github.com/login' /*'https://github.com/explore'*/,
